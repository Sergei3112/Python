...
koef1 = create_mn(k1)
koef2 = create_mn(k2)
write_file("file20_1.txt", create_str(koef1))
write_file("file20_2.txt", create_str(koef2))

# нахождение суммы многочлена

with open('file20_1.txt', 'r') as data:
    st1 = data.readlines()
with open('file20_2.txt', 'r') as data:
    st2 = data.readlines()
...
write_file("file20_res.txt", create_str(lst_new))
with open('file20_res.txt', 'r') as data:
    st3 = data.readlines()
